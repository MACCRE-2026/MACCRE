...
Write-Host ""
Write-Host "  3. Launch the Textual NexusPlex TUI:"
Write-Host "     python run.py"
Write-Host ""
Write-Host "  4. Refresh the operator workbook:"
Write-Host "     python maccre.py workbook refresh --project MyProject"
Write-Host ""
Write-Host "  5. Open MACCRE_Global.xlsx, fill AGENTS + TOPOLOGY + SWARM_REQUEST"
Write-Host ""
Write-Host "  6. Fire:"
